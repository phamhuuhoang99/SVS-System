<footer>
    <div class="background-primary padding text-center">
        <p class="h1">Contact Us: 4521 800 500</p>
    </div>
    <!-- Main Footer -->
            ...
            <div class="padding-2x">
                <div class="line">
                    ...
                    <div class="margin-left-70 margin-bottom-30">
                        ...
                        <p>Responsive Street 7<br> London / United Kingdom / Europe
                        </p>
                    </div>
                    <div class="float-left">
                    ...
                    <div class="margin-left-70 margin-bottom-30">
                        ...
                        <p>contact@sampledomain.com<br> office@sampledomain.com
                        </p>
                    </div>
                    <div class="float-left">
                    ...
                    <div class="margin-left-70">
                        ...
                        <p>0800 4521 800 50<br> 0450 5896 625 16<br> 0798 6546 465 15
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="padding background-dark full-width">
        ...
        <div class="s-12 l-6">
            <a class="right text-size-12" href="http://smartvietsolution.com" title="Responsee - lightweight responsive framework">Design and coding<br> by SmartVietSolution</a>
        </div>
    </section>
</footer>