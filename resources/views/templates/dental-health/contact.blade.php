...
@section('content')
    ...
    <section class="mail pt-lg-5 pt-4">
        <div class="container pt-lg-5">
            <h2 class="heading text-center mb-sm-5 mb-4">Liên hệ với chúng tôi </h2>
            <div class="row agileinfo_mail_grids">
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4 contact-info">
                    ...
                    <p><span class="fa mr-2 fa-map-marker"></span>Quận Gò Vấp,<span>Hồ Chí Minh</span></p>
                    <p class="phone py-2"><span class="fa mr-2 fa-phone"></span>Số điện thoại : 035 618 5047 </p>
                    <p><span class="fa mr-2 fa-envelope"></span>Email : <a
                            href="mailto:info@example.com">smartvietsolution@gmail.com</a></p>

                    <h4 class="my-4">Đặt Lịch Hẹn</h4>
                    <p class="phone"><span class="fa mr-2 fa-phone"></span>Gọi 035 618 5047 </p>
                </div>
            </div>
        </div>
        <div class="map mt-5">
