...
<header>
        ...
        <div class="container">
            <div class="row">
                <h1 class="text-capitalize text-white col-7">
                    <i class="fas fa-book text-dark bg-white p-2 rounded-circle mr-3"></i>Chào mừng bạn đến edulearn</h1>
                <!-- social icons -->
    ...
    <div class="middle-w3ls-nav py-2">
        <div class="container">
            <div class="row">
                <a class="logo font-italic font-weight-bold col-lg-3 text-lg-left text-center" href="{{route('temp.edulearn.index') }}">Edulearn</a>
                <div class="col-lg-9 right-info-agiles mt-lg-0 mt-sm-3 mt-1">
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-6 nav-middle mt-sm-0 mt-2">
                            ...
                            <div class="agile-addresmk">
                                <p>
                                    <span class="font-weight-bold text-dark">Số điện thoại</span> 035 618 5047
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-4 col-6 top-login-butt text-right mt-sm-2">
                            <a href="{{route('temp.edulearn.login') }}" class="button-head-mow3 text-white">Đăng nhập</a>
                        </div>
                    </div>
                </div>
            </div>
