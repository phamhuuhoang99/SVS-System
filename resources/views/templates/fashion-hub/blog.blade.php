        ...
        <div class="container">
            ...
            <div class="row card-columns py-lg-5">
                <div class="col-md-4 p-0">
                    <div class="card">
                        <a href="single.html">
                            <img class="card-img-top" src={{ asset("templates/fashion-hub/img/blg1.jpg") }} alt="Card image cap">
                        </a>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <a href="single.html">
                            <img class="card-img-top" src={{ asset("templates/fashion-hub/img/a2.jpg") }} alt="Card image cap">
                        </a>
                        <div class="card-body">
                            <h5 class="card-title blg_w3ls">
                                <a href="single.html">Blog Title</a>
                ...
                <div class="col-md-4 0">
                    ...
                    <div class="card text-white text-center">
                        <a href="single.html">
                            <img class="card-img" src={{ asset("templates/fashion-hub/img/a3.jpg") }} alt="Card image">
                        </a>
                ...
                <div class="col-md-4 p-0">
                    <div class="card">
                        <a href="single.html">
                            <img class="card-img" src={{ asset("templates/fashion-hub/img/blg2.jpg") }} alt="Card image">
                        </a>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <a href="single.html">
                            <img class="card-img-top" src={{ asset("templates/fashion-hub/img/i10.jpg") }} alt="Card image cap">
                        </a>
                    </div>
                </div>
            </div>
