        ...
        <nav class="navbar nav_bottom">
            ...
            <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav nav_1">
                    <li><a href="products.html">Thực phẩm có thương hiệu</a></li>
                    <li><a href="household.html">Hộ gia đình</a></li>
                    <li class="dropdown mega-dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Trái cây và rau<span class="caret"></span></a>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Thức ăn đông lạnh<span class="caret"></span></a>
                        <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                            <div class="w3ls_vegetables">
                                <ul>
                                    <li><a href="frozen.html">Đồ ăn nhẹ đông lạnh</a></li>
                                    <li><a href="frozen.html">Nonveg đông lạnh</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                    <li><a href="bread.html">Tiệm bánh mỳ</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </nav>
