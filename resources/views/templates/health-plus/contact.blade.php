...
@section('content')
    ...
    <div class="banner-bottom" id="about">
        <div class="container">
            <h2 class="w3_heade_tittle_agile">Liên hệ với chúng tôi</h2>
            ...
            <div class="contact-top-agileits">
                <div class="col-md-4 contact-grid ">
                    <div class="contact-grid1 agileits-w3layouts">
                        ...
                        <div class="con-w3l-info">
                            <h4>Địa chỉ </h4>
                            <p>Quận Gò Vấp, <span>Hồ Chí Minh City.</span></p>
                        </div>
                ...
                <div class="col-md-4 contact-grid">
                    <div class="contact-grid3 w3l">
                        ...
                        <div class="con-w3l-info">
                            <h4>Email</h4>
                            <p><a href="mailto:info@example.com">smartvietsolution@gmail.com</a>
            ...
            <div class="contact-form-aits">
                <form action="#">
                    <input type="text" class="margin-right" name="Họ tên" placeholder="Name" required="">
                    <input type="email" name="Email" placeholder="Email" required="">
                    <input type="text" class="margin-right" name="Phone Number" placeholder="Số điện thoại" required="">
