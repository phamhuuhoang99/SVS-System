...
(function($) {
    ...
    var loadMyCartEvent = function(userOptions) {
        ...
        var drawTable = function() {
            ...
            $.each(products, function() {
                ...
                $cartTable.append(
                    ...
                    '<td>' + this.name + '</td>' +
                    '<td title="Unit Price">đ' + this.price + '</td>' +
                    '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
                    '<td title="Tổng tiền" class="' + classProductTotal + '">đ' + total + '</td>' +
            ...
            $cartTable.append(products.length ?
                ...
                '<td></td>' +
                '<td></td>' +
                '<td><strong id="' + idGrandTotal + '">đ</strong></td>' +
                '<td></td>' +
                '</tr>' :
                '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">Giỏ hàng còn trống</div>'
            );
            ...
            if (products.length && discountPrice !== null) {
                $cartTable.append(
                    '<tr style="color: red">' +
                    '<td></td>' +
                    '<td><strong>Tổng tiền (bao gồm giảm giá)</strong></td>' +
                    '<td></td>' +
                    '<td></td>' +
                    '<td><strong id="' + idDiscountPrice + '">đ</strong></td>' +
                    '<td></td>' +
                    '</tr>'
                );
            }
        ...
        var showGrandTotal = function() {
            $("#" + idGrandTotal).text("đ" + ProductManager.getTotalPrice());
        }
        var showDiscountPrice = function() {
            $("#" + idDiscountPrice).text("đ" + options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity()));
        }
        ...
        */
        ...
        $(document).on("input", "." + classProductQuantity, function() {
            ...
            $(this).parent("td").next("." + classProductTotal).text("đ" + price * quantity);
