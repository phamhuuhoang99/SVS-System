$.fn.memenu = function(e) {
    function r() {
        ...
        if (window.innerWidth <= 768) {
            o();
            s();
            if (n == 0) { $(".memenu > li:not(.showhide)").hide(0) }
        } else {
            u();
            i()
        }
    ...
    function i() { $(".memenu li").bind("mouseover", function() { $(this).children(".dropdown, .mepanel").stop().fadeIn(t.interval) }).bind("mouseleave", function() { $(this).children(".dropdown, .mepanel").stop().fadeOut(t.interval) }) }
