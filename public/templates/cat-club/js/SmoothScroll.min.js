!(function() {
    ...
    function r(e) {
        ...
        return (
            ...
            1 === e.deltaMode && ((a *= 40), (i *= 40)), !z.touchpadSupport && v(i) ?
            !0 :
    ...
    function a(e) {
        var t = e.target,
            ...
            e.altKey ||
            e.metaKey ||
            (e.shiftKey && e.keyCode !== N.spacebar);
        ...
        if (
            ...
            return !0;
        if (
            (w(t, "button") || (w(t, "input") && a.test(t.type))) &&
            e.keyCode === N.spacebar
        )
            return !0;
        var i,
            c = 0,
